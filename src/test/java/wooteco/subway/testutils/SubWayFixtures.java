...
public class SubWayFixtures {
    ...
    public static final Station 백번_백역 = new Station(100L, "백역");
    public static final Station 백일번_백일역 = new Station(101L, "백일역");
    public static final Station 이백번_이백역 = new Station(200L, "이백역");
    public static final Station 이백일번_이백일역 = new Station(201L, "이백일역");
    ...
    public static final Section 일호선_구간_1번역_2번역 = new Section(1L, 일번역_강남, 이번역_선릉, 1);
    public static final Section 일호선_구간_1번역_3번역 = new Section(1L, 일번역_강남, 삼번_잠실역, 2);
    public static final Section 일호선_구간_1번역_2번역_거리_10 = new Section(1L, 일번역_강남, 이번역_선릉, 10);
    public static final Section 일호선_구간_2번역_3번역_거리_12 = new Section(2L, 이번역_선릉, 삼번_잠실역, 12);
    public static final Section 일호선_구간_1번역_3번역_거리_22 = new Section(3L, 1L, 일번역_강남, 삼번_잠실역, 22);
    ...
    public static final Section 일호선_구간_1번역_5번역_거리_31 = new Section(6L, 1L, 일번역_강남, 오번_신림역, 31);
}
